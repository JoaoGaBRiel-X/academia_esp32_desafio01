                               ...
                               int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_DATA:
        ...
        if (strncmp(event->data, "alert", event->data_len) == 0 && event->data_len == strlen("alert"))
        {
            alert_event = true;
        }
        else if (strncmp(event->data, "no_alert", event->data_len) == 0 && event->data_len == strlen("no_alert"))
        {
            alert_event = false;
        }
        break;
